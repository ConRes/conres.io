...
/**
 * Flag to signal the Color Engine Plugin that this transform's Lab 16-bit
 * input should be promoted to float for pipeline evaluation. Used by the
 * K-Only GCR concatenated pipeline to avoid 16-bit precision artifacts.
 *
 * Bit 28 - verified unused in Little-CMS (lcms2.h lines 1722-1756)
 */
#define cmsFLAGS_LAB16_FLOAT_PROMOTION  0x10000000
