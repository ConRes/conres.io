 ...
 */
#define cmsFLAGS_DEBUG_K_ONLY_GCR  0x40000000
...
typedef struct {
    ...
    cmsFloat64Number kOnlyBpcScale;
    ...
    cmsBool          isMaximumGCR;     // Profile already uses max GCR
 ...
 * @param scale BPC scale factor from ComputeKOnlyBPCScale
