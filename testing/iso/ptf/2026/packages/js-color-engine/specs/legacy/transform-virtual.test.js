...
describe('Transform Virtual', () => {
    ...
    test('Lab to Lab [legacy]', ({ assert }) => {
        const lab2lab = new Transform({ useLegacy: true });
    ...
    test('Lab to srgb (int) [legacy]', ({ assert }) => {
        const lab2srgb = new Transform({ useLegacy: true });
    ...
    test('Lab to srgb (3 decimals) [legacy]', ({ assert }) => {
        const lab2srgb = new Transform({ precision: 3, useLegacy: true });
    ...
    test('srgb to Lab (no rounding) [legacy]', ({ assert }) => {
        const rgb2lab = new Transform({ roundOutput: false, useLegacy: true });
    ...
    test('sRGB to Adobe1998RGB [legacy]', ({ assert }) => {
        const rgb2rgb = new Transform({ useLegacy: true });
