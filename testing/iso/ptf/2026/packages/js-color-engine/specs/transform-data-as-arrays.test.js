...
describe('Transform Data as Arrays', () => {

    test('sRGB to CMYK via arrays', async ({ assert }) => {
        ...
        const rgb2CMYK = new Transform({ dataFormat: 'int8' });
    ...
    test('sRGB+Alpha to CMYK via arrays', async ({ assert }) => {
        const cmykProfile = new Profile();
    ...
    test('sRGB+Alpha to CMYK+Alpha via arrays', async ({ assert }) => {
        const cmykProfile = new Profile();
    ...
    test('sRGB+Alpha to CMYK+Alpha via arrays with PRESERVE Alpha', async ({ assert }) => {
        const cmykProfile = new Profile();
    ...
    test('sRGB+Alpha to CMYK+Alpha via arrays with PRESERVE Alpha with length of 3', async ({ assert }) => {
        const cmykProfile = new Profile();
    ...
    test('sRGB+Alpha to CMYK+Alpha via arrays with PRESERVE Alpha with length of 3 as Uint8ClampedArray', async ({ assert }) => {
        const cmykProfile = new Profile();
