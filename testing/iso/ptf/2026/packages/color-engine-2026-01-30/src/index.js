...
/**
 * Enable explicit BPC scaling for multiprofile LUT creation.
 * Uses 32-bit float intermediates and applies XYZ-space BPC scaling
 * to ensure pure black → pure black mapping.
 * @type {number}
 */
export const cmsFLAGS_MULTIPROFILE_BPC_SCALING = 0x20000000;
...
export const VERSION = '2026-01-30';
