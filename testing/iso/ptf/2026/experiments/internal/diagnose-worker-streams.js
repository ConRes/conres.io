...
const PTF_ROOT = resolve(__dirname, '../../..');

// Import services
const PDFLib = await import(resolve(PTF_ROOT, '2026/packages/pdf-lib/pdf-lib.esm.js'));
const { PDFDocument, PDFDict, PDFName, PDFArray, PDFRef, PDFRawStream } = PDFLib;

const ColorConversionUtils = await import(resolve(PTF_ROOT, '2026/services/ColorConversionUtils.js'));
const LittleCMS = await import(resolve(PTF_ROOT, '2026/packages/color-engine/src/index.js'));
const pako = await import('pako');

// Test PDF path — update to use 2026 test fixtures or pass as argument
const TEST_PDF_PATH = resolve(PTF_ROOT, '2026/tests/fixtures/pdfs/2025-08-15 - ConRes - ISO PTF - CR1 (F9d) Fixtures - F-01.pdf');

// ICC Profile path
const ICC_PROFILE_PATH = resolve(PTF_ROOT, '2026/tests/fixtures/profiles/eciCMYK v2.icc');
