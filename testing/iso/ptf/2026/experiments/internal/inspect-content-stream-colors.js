...
`);
    ...
    // Load dependencies
    const { PDFDocument, PDFName, PDFArray, PDFRef, PDFRawStream, PDFDict } = await import('../../packages/pdf-lib/pdf-lib.esm.js');
    const { PDFContentStreamColorConverter } = await import('../../classes/baseline/pdf-content-stream-color-converter.js');
