...
**DO:** Phase 2 → Phase 3 → Phase 4 (base class first, then leaf classes)
...
```
ColorConverter (base) ← owns #ready, #initialize(), ensureReady()
...
- [ ] Phase 5: Verify Separation of Concerns `PENDING`
- [ ] Phase 6: Final Regression Verification `PENDING`
