 ...
 *
 * Safely propagates working tree changes from conres.io to conres.io-staging
 * for deployment testing, with parent commit protection.
 *
 * Background:
 *   The conres.io-staging repository provides a deployment target for testing
 *   the 2025/generator prototype. Its baseline state preserves pre-existing
 *   implementations from a known parent commit. Changes from this development
 *   project are layered on top — but files that exist in the parent commit are
 *   NEVER auto-synced, to prevent breaking existing code.
 *
 * How it works:
 ...
 *   generator  — testing/iso/ptf/2025/generator/  (generator prototype UI)
 *   assets     — testing/iso/ptf/assets/           (asset PDFs, manifests, profiles)
 *   classes    — testing/iso/ptf/2025/classes/     (shared ecosystem classes)
...
const ALL_SYNC_GROUPS = [
    { name: 'generator', path: 'testing/iso/ptf/2025/generator' },
    { name: 'assets', path: 'testing/iso/ptf/assets' },
    { name: 'classes', path: 'testing/iso/ptf/2025/classes' },
    { name: 'packages', path: 'testing/iso/ptf/2025/packages' },
    { name: 'services', path: 'testing/iso/ptf/2025/services' },
];
 ...
 */
const EXCLUDE_SUFFIXES = ['PROGRESS.md', '-backup'];
