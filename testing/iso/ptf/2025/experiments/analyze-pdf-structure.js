...
function extractImageInfo(stream, context) {
    ...
    return { width, height, bpc, colorSpace, filter, size };
}
 ...
 */
function printResourceToPageView(analysis, fileName, pageCount) {
...
async function main() {
    ...
    if (viewMode === 'page-to-resource') {
        ...
        printResourceToPageView(analysis1, fileName1, pdfDoc1.getPageCount());
    }
