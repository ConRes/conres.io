...
describe('Transform Invalid [legacy]', () => {

    function incorrectLabInput() {
        const rgb2lab = new Transform({ useLegacy: true });
    ...
    test('incorrect Lab Input [legacy]', ({ assert }) => {
    ...
    function inputProfileNotLoaded() {
        ...
        const testTransform = new Transform({ useLegacy: true });

        testTransform.create(inputProfile, '*lab', eIntent.absolute);
    }


    test('input Profile Not Loaded [legacy]', ({ assert }) => {
    ...
    test('output Profile Not Loaded [legacy]', ({ assert }) => {
    ...
    test('output Profile is not a profile [legacy]', ({ assert }) => {
    ...
    test('input Profile is not a profile [legacy]', ({ assert }) => {
    ...
    test('incorrect Virtual Profile String [legacy]', ({ assert }) => {
    ...
    test('multiStage Not Array [legacy]', ({ assert }) => {
    ...
    test('multiStage No Output Profile [legacy]', ({ assert }) => {
    ...
    test('multiStage Missing Last Item [legacy]', ({ assert }) => {
    ...
    test('Intent is a string [legacy]', ({ assert }) => {
    ...
    test('Intent is invalid number [legacy]', ({ assert }) => {
