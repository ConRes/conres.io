...
describe('Transform Data Format [legacy]', () => {

    test('Lab to srgb as objectFloat [legacy]', ({ assert }) => {
        const lab2srgb = new Transform({ dataFormat: 'objectFloat', useLegacy: true });
    ...
    test('Lab to CMYK as objectFloat ', async ({ assert }) => {
        ...
        const lab2CMYK = new Transform({ dataFormat: 'objectFloat', useLegacy: true });
    ...
    test('srgb to Lab as objectFloat [legacy]', ({ assert }) => {
        const rgb2lab = new Transform({ dataFormat: 'objectFloat', useLegacy: true });
    ...
    test('sRGB to CMYK as device [legacy]', async ({ assert }) => {
        const cmykProfile = new Profile();
        ...
        const lab2CMYK = new Transform({ dataFormat: 'device', useLegacy: true });
    ...
    test('srgb to Lab as device [legacy]', ({ assert }) => {
        const rgb2lab = new Transform({ dataFormat: 'device', useLegacy: true });
    ...
    test('srgb to adobe1998 as int8 [legacy]', ({ assert }) => {
        const rgb2lab = new Transform({ dataFormat: 'int8', useLegacy: true });
