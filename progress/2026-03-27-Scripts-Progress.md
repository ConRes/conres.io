...
- [x] `git mv 2026/experiments/convert-pdf-color.js 2025/experiments/convert-pdf-color.js`
- [x] `git mv 2026/experiments/compare-pdf-color.js 2025/experiments/compare-pdf-color.js`
- [x] `git mv 2026/experiments/tiff-diff-r1.js 2025/experiments/tiff-diff-r1.js`
- [x] `git mv 2026/experiments/color-engine-benchmark.js 2025/experiments/color-engine-benchmark.js`

### Phase 1: Rename and restructure in 2026 (Table 3a, 3b)

Primary renames:

- [x] `git mv 2026/experiments/convert-pdf-color-baseline.js 2026/experiments/convert-pdf-color.js`
- [x] `git mv 2026/experiments/compare-pdf-color-baseline.js 2026/experiments/compare-pdf-color.js`

Create internal structure and move from primary to internal:

- [x] Create `2026/experiments/internal/legacy/`
- [x] `git mv 2026/experiments/comprehensive-k-only-diagnostic.js 2026/experiments/internal/diagnose-k-only-gcr.js`
- [x] `git mv 2026/experiments/diagnose-worker-content-streams.js 2026/experiments/internal/diagnose-worker-streams.js`
- [x] `git mv 2026/experiments/convert-diagnostics-profile.js 2026/experiments/internal/convert-diagnostics-profile.js`
- [x] `git mv 2026/experiments/extract-pdf-text.js 2026/experiments/internal/extract-pdf-text.js`
- [x] `git mv 2026/experiments/parse-preflight-report.js 2026/experiments/internal/parse-preflight-report.js`

Move legacy spawns to internal:

- [x] `git mv 2026/experiments/legacy/convert-pdf-color.js 2026/experiments/internal/legacy/convert-pdf-color.js`
- [x] `git mv 2025/experiments/scripts/legacy/convert-colors.js 2026/experiments/internal/legacy/convert-colors.js`
- [x] `git mv 2025/experiments/scripts/legacy/inspect-content-stream-colors.js 2026/experiments/internal/legacy/inspect-content-stream-colors.js`
- [x] `git mv 2025/experiments/scripts/legacy/trace-pdf-conversion.js 2026/experiments/internal/legacy/trace-pdf-conversion.js`
- [x] `git mv 2025/experiments/scripts/diagnose-worker-lifecycle.html 2026/experiments/internal/diagnose-worker-lifecycle.html`
- [x] Remove empty `2026/experiments/legacy/`
- [x] Note: `legacy/benchmark-final.js` and `legacy/benchmark-transform-methods.js` stay in 2025 (parent tools left behind)

### Phase 2: Move primary tool from 2025 (Table 3c)

- [x] `git mv 2025/experiments/scripts/generate-verification-matrix-baseline.mjs 2026/experiments/generate-verification-matrix.mjs`
- [x] Update `../classes/` → `classes/` (now sibling to `classes/`)
- [x] Verify loads with `--help`

### Phase 3: Move and refactor internal tools from 2025 (Table 4a)

- [x] `git mv 2025/experiments/scripts/convert-colors.js 2026/experiments/internal/convert-colors.js`
- [x] `git mv 2025/experiments/scripts/inspect-content-stream-colors.js 2026/experiments/internal/inspect-content-stream-colors.js`
- [x] `git mv 2025/experiments/scripts/trace-pdf-conversion.js 2026/experiments/internal/trace-pdf-conversion.js`
- [x] `git mv 2025/experiments/scripts/analyze-image-masking.mjs 2026/experiments/internal/analyze-image-masking.mjs`
- [x] `git mv 2025/experiments/scripts/compare-color-values.js 2026/experiments/internal/compare-color-values.js`
- [x] Update `../../classes/<file>.js` → `../../classes/baseline/<file>.js` in dual-mode tools
- [x] Update `--legacy` dynamic import path to `legacy/` (relative to `internal/`)
- [x] Verify each loads with `--help` and `--legacy`

### Phase 4: Create consolidated internal tools (Table 4b)

- [x] Create `2026/experiments/internal/inspect-color-engine.js` with 6 modes
- [x] Create `2026/experiments/internal/test-experiment-classes.js` with 5 suites
- [x] Verify all modes/suites run

### Phase 5: Consolidate features into tools (Table 5) and fix imports

Primary tools:

- [x] Add `--show-bitdepths`, `--show-masks`, `--show-placement`, `--show-endianness` to `2026/experiments/analyze-pdf-structure.js`
- [x] Add `--quick` to `2026/experiments/pdf-diff.js`
- [x] Fix `from 'pdf-lib'` → vendored in: `analyze-pdf-structure.js`, `compare-pdf-outputs.js`, `pdf-diff.js`, `validate-pdf.js`

Internal tools:

- [x] Add `--check-replacements`, `--inspect` to `2026/experiments/internal/convert-diagnostics-profile.js`
- [x] Fix `from 'pdf-lib'` → vendored in: `internal/extract-pdf-text.js`
- [x] Fix `2025/` hardcoded paths in `internal/diagnose-worker-streams.js` → 2026 equivalents
- [x] Verify new flags and fixed imports work

### Phase 6: Create READMEs

- [x] Create `2026/experiments/README.md` — accessible explainer, links to `internal/README.md`
- [x] Create `2026/experiments/internal/README.md` — table of internal tools with purpose and usage

### Phase 7: Final validation

- [x] Run each primary tool with `--help` — confirm 9 tools load
- [x] Run `2026/experiments/generate-verification-matrix.mjs` end-to-end with a config
- [x] Run `2026/experiments/internal/convert-colors.js` with and without `--legacy`
- [x] Run `2026/experiments/internal/inspect-color-engine.js --smoke-test`
- [x] Run `2026/experiments/internal/test-experiment-classes.js --suite=all`
- [x] Final `ls`: confirm `2026/experiments/*.{js,mjs}` shows exactly 9 tool files + README
- [x] Update any remaining hardcoded `2025` paths to `2026`
...
- Executed Phase 0: reverted 4 broken/obsolete files to 2025
- Executed Phase 1: renamed 2 primary tools (drop `-baseline`), moved 5 tools to `internal/`, moved 4 legacy scripts to `internal/legacy/`, moved HTML diagnostic to `internal/`
- Executed Phase 2: moved `generate-verification-matrix.mjs` to primary, fixed `./classes/` path
- Executed Phase 3: moved 5 internal tools from 2025 scripts, fixed `../../classes/` → `baseline/`, fixed `--legacy` paths
- Executed Phase 4: created `internal/inspect-color-engine.js` (6 modes), `internal/test-experiment-classes.js` (5 suites)
- Executed Phase 5: fixed `from 'pdf-lib'` → vendored in 9 files across primary + internal + legacy, fixed `2025/` paths in `diagnose-worker-streams.js`
- Executed Phase 6: created `experiments/README.md` and `internal/README.md`
- Executed Phase 5 (flags): added `--show-bitdepths`, `--show-masks`, `--show-placement`, `--show-endianness` to `analyze-pdf-structure.js`; added `--check-replacements`, `--inspect` to `convert-diagnostics-profile.js`; added `--quick` (stub) to `pdf-diff.js`
- Executed Phase 6: created `experiments/README.md` and `internal/README.md`
- Validated: all 8 primary tools load with `--help`; `inspect-color-engine.js --smoke-test` passes; `inspect-color-engine.js --dump-formats` passes; `test-experiment-classes.js --suite=all` 31/31 pass; all 12 internal tools load; zero npm `from 'pdf-lib'` imports remaining
- Fixed: `printResourceToPageView` made async for `--show-endianness` pako import; `test-experiment-classes.js` API corrections (metricDefinitions is object not array, getMetrics not getResults, addValues takes iterable, registeredMetrics → metricNames, extractColors is static)
- Remaining: Phase 7 final validation — run tools on real PDFs, verify `generate-verification-matrix.mjs` end-to-end
